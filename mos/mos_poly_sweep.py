...
OUT = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "out", "mos_poly")
...
def main():
    ...
    fig.tight_layout()
    fig.savefig(os.path.join(OUT, "doping_comparison.png"), dpi=150)
    plt.close(fig)

    csv_path = os.path.join(OUT, "doping_sweep_summary.csv")
    ...
    print(f"\nSaved: {os.path.join(OUT, 'doping_comparison.png')}")
